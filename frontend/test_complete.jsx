...
const Worksheets = () => {
const worksheetData = {loaded: true, viewOnly: false, tests: [], isCustom: false, machine: {manufacturer: 'Test', model: 'Test', location: {building: 'Test', room: 'Test'}}, frequency: 'daily'};
const getFrequencyIcon = () => '📅';
const getFrequencyLabel = () => 'Daily';
return (
      {/* Generated Worksheet */}
      {worksheetData && (
